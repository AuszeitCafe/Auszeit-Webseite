      ...
      <div className="container mx-auto px-4">
        ...
        <div>
          <p className="text-lg text-muted-foreground mb-6 text-justify">
            Unser Café ist ein Ort zum Wohlfühlen – eine kleine Auszeit vom Alltag.
            In entspannter, liebevoll gestalteter Atmosphäre verwöhnen wir Sie mit frisch gebrühten Kaffeespezialitäten,
            hausgemachten Kuchen und ausgesuchten Köstlichkeiten.
          </p>
          <p className="text-lg text-muted-foreground mb-6 text-justify">
            Ob zum Frühstück, beim genussvollen Brunch oder beim gemütlichen Nachmittagskaffee –
            bei uns finden Sie zu jeder Tageszeit genau das Richtige.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-12 items-center">
          ...
          <div className="order-1 md:order-2">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6 font-madelyn text-xl text-foreground">
